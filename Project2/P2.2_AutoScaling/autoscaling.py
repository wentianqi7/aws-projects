...
dataCenterAMI = 'ami-ec14ba84'
loadGeneratorAMI = 'ami-562d853e'
...
elb_conn = boto.ec2.elb.connect_to_region(conn_region, aws_access_key_id = AWS_Access_Key_Id, aws_secret_access_key = AWS_Secret_Key)
...
asg_conn = boto.ec2.autoscale.connect_to_region(conn_region, aws_access_key_id = AWS_Access_Key_Id,aws_secret_access_key = AWS_Secret_Key)
launch_config = LaunchConfiguration(name = 'tianqiw_2.2_config', image_id = dataCenterAMI,
                            ...
                            instance_type = instance_type, instance_monitoring = True)
...
cloudwatch_conn = boto.ec2.cloudwatch.connect_to_region(conn_region, aws_access_key_id = AWS_Access_Key_Id,aws_secret_access_key = AWS_Secret_Key)
alarm_dimensions = {"AutoScalingGroupName": asg_name}

scale_up_alarm = MetricAlarm(
            name = 'scale_up_on_cpu', namespace = 'AWS/EC2',
            metric = 'CPUUtilization', statistic = 'Average',
            comparison = '>=', threshold = '86',
